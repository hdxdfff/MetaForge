...
if /I "%action%"=="bridge" goto :bridge
...
:bridge
call "%VM_ROOT%vm-bridge.cmd" %1 %2 %3 %4 %5 %6 %7 %8 %9
exit /b %errorlevel%
...
echo   vmctl.cmd ssh -ScriptPath D:\codex\tools\script.sh
echo   vmctl.cmd script D:\codex\tools\script.sh
