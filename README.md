# MetaForge backup entry point

This repository now exposes two separate backup tracks, each with its own directory.

## Project 1: MetaForge

- Entry page: [backups/metaforge/README.md](backups/metaforge/README.md)
...
- Entry page: [backups/toyos/README.md](backups/toyos/README.md)
- Manifest: [backups/toyos-project-backup-20260404-023214.manifest.json](backups/toyos-project-backup-20260404-023214.manifest.json)
- Archive: [backups/toyos-project-backup-20260404-023214.zip](backups/toyos-project-backup-20260404-023214.zip)
